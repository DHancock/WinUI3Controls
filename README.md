...
|Version|Changes|
|-------|:------|
|2.4.2|Fix reliability issues when the package is used in AOT builds|
|2.4.1|Add a work arround for issue [#59](https://github.com/DHancock/WinUI3Controls/issues/59)|
